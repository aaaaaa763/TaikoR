...
namespace TJAPlayer3
{
	internal sealed class CActFIFOResult : CActivity
	{
        ...
        public void tフェードアウト開始()
        {
            ...
            counter = new CCounter(0, 500, 3, TJAPlayer3.Timer);
		...
		public override int On進行描画()
		{
			...
			if (TJAPlayer3.Tx.Result_FadeIn != null)
			{
                ...
                {
					TJAPlayer3.Tx.Result_FadeIn.Opacity = ((this.counter.n現在の値 * 0xff) / 100);
					TJAPlayer3.Tx.Result_FadeIn.t2D描画(TJAPlayer3.app.Device, 0, 0);
                }
                else
                {
